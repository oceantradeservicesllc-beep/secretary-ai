...
const TITLES = {
  ...
  category:'Category', priority:'Priority', stocks:'Stock Intelligence',
  trading:'Active Trading', perf:'Performance',
}
...
function Shell() {
  ...
  const Screen = {
    ...
    stocks: Stocks, trading: Trading, perf: Performance,
  }[screen] || Dashboard
  ...
  return (
    <div style={{maxWidth:480,margin:'0 auto',minHeight:'100vh',background:C.bg,position:'relative'}}>
      ...
      {/* FAB — hide on stocks, trading, perf */}
      {!['stocks','trading','perf'].includes(screen)&&(
