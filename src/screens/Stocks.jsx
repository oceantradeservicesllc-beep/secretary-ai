...
export default function Stocks() {
  ...
  const runAnalysis = useCallback(async (timeSlot='morning') => {
    ...
    // Fetch live data sequentially to avoid rate limits
    const marketTickers = ['SPY','QQQ','VV','XRP-USD','SOL-USD','NVDA']
    const liveResults = {}
    for (const t of marketTickers.slice(0,4)) {
      try {
      ...
      } catch(e) { console.warn(`Failed to fetch ${t}:`, e) }
    }
